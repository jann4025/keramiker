    ...
    return t.m = e, t.c = n, t.p = "/dev/", t(0)
            ...
            var o = n(6),
                ...
                l = function e(t, n, l) {
                    var p, u, f, d, g = t & e.F,
                        ...
                        v = t & e.P,
                        w = t & e.B,
                        m = h ? o : b ? o[n] || (o[n] = {}) : (o[n] || {})[c],
                        y = h ? i : i[n] || (i[n] = {}),
                        x = y[c] || (y[c] = {});
                    h && (l = n);
                    for (p in l) u = !g && m && void 0 !== m[p], f = (u ? m : l)[p], d = w && u ? s(f, o) : v && "function" == typeof f ? s(Function.call, f) : f, m && a(m, p, f, t & e.U), y[p] != f && r(y, p, d), v && x[p] != f && (x[p] = f)
                };
            ...
            e.exports = function (e, t) {
                ...
                return function (t, s, g) {
                    for (var h, b, v = r(t), w = i(v), m = o(s, g, 3), y = a(w.length), x = 0, C = n ? d(t, y) : c ? d(t, 0) : void 0; y > x; x++)
                        if ((f || x in w) && (h = w[x], b = m(h, x, v), e))
                            if (n) C[x] = b;
                            else if (b) switch (e) {
                        case 3:
                            return !0;
                ...
                c = function (e, t, n) {
                    ...
                    l.initialize = function () {
                        l.logError = r.withModule(s), o(function () {
                            t = t || window.document.body, l.collectWidgets(t), l.boot(l.observe.bind(l))
                        })
                    }, l.facade = function () {
                        return new a(l)
                        ...
                        if ("div" === e.tagName.toLowerCase()) {
                            var t, n = e.className.split(" ");
                            return 1 === n.length ? t = e.className : n.length > 1 && n.forEach(function (e) {
                                if (~e.indexOf("elfsight-app")) return void(t = e)
                            }), t.replace("elfsight-app-", "")
                        }
                        ...
                        var t = l.getWidgetIdByElement(e),
                            o = p[t];
                        return o.data && (o.data.id = t, o.data.platform = !0), o ? o.status ? (o.user && (o.data.isOwner = o.user.owner), void n.initWidget(e, o.data)) : void l.logError('Widget "' + t + '" can`t be initialized because ' + o.reason, e) : void l.logError('Widget "' + t + '" isn`t required', e)
                    }, l.boot = function (t, n) {
                        ...
                        e[r] = function (n) {
                            e[r] = void 0, e.document.head.removeChild(a), n.status || l.logError("Boot failed because " + n.reason, n.data), p = Object.assign({}, p, n.data.widgets), l.loadAssets(n.data.assets), f.forEach(l.initWidget.bind(l)), t && t()
                        };
                        ...
                        a.src = o + "?" + s, e.document.head.appendChild(a)
                    }, l.revise = function () {
                        ...
                        if (window.MutationObserver && !c) {
                            ...
                            c = new MutationObserver(function (e) {
                                ...
                                e.forEach(function (e) {
                                    var t = function (e) {
                                        l.getWidgetsElements(e).forEach(n)
                                    };
                                    Array.prototype.forEach.call(e.addedNodes, t)
                                }), t && clearTimeout(t), t = setTimeout(function () {
                                    l.revise()
                                }, 500)
                            }), c.observe(window.document, e)
                        }
                    }, l.initialize()
                };
            e.exports = c
            ...
            (function (t) {
                ...
                function r(e, t) {
                    var n = b(),
                        o = m[m.length - 1];
                    if ("top" === e.insertAt) o ? o.nextSibling ? n.insertBefore(t, o.nextSibling) : n.appendChild(t) : n.insertBefore(t, n.firstChild), m.push(t);
                    else {
